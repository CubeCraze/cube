export const tpdaLiquidationRouterABI = [
    {
      inputs: [
        { internalType: 'contract TpdaLiquidationPairFactory', name: 'liquidationPairFactory_', type: 'address' }
      ],
      stateMutability: 'nonpayable',
      type: 'constructor'
    },
    { inputs: [{ internalType: 'address', name: 'sender', type: 'address' }], name: 'InvalidSender', type: 'error' },
    { inputs: [{ internalType: 'uint256', name: 'deadline', type: 'uint256' }], name: 'SwapExpired', type: 'error' },
    { inputs: [], name: 'UndefinedTpdaLiquidationPairFactory', type: 'error' },
    { inputs: [{ internalType: 'address', name: 'liquidationPair', type: 'address' }], name: 'UnknownTpdaLiquidationPair', type: 'error' },
    {
      anonymous: false,
      inputs: [
        { indexed: true, internalType: 'contract TpdaLiquidationPairFactory', name: 'liquidationPairFactory', type: 'address' }
      ],
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: true, internalType: 'contract TpdaLiquidationPair', name: 'liquidationPair', type: 'address' },
